...
col_3.markdown(f"Nama Negara    : {Nama_lengkap_negara}")
col_3.markdown(f"Kode Negara    : {code_negara}")
col_3.markdown(f"Region         : {region}")
col_3.markdown(f"Sub Region     : {sub_region}")
col_3.markdown(f"Total Produksi : {Jumlah_produksi}")
...
col_4.markdown(f"Nama Negara    : {nm_negara}")
col_4.markdown(f"Kode Negara    : {code_ngr}")
col_4.markdown(f"Region         : {reg}")
col_4.markdown(f"Sub Region     : {sub_reg}")
col_4.markdown(f"Total Produksi : {Jumlah_prdks}")
...
col_3.markdown(f"Nama Negara    : {nmlngkp_negara}")
col_3.markdown(f"Kode Negara    : {cod_ngr}")
col_3.markdown(f"Region         : {regi}")
col_3.markdown(f"Sub Region     : {sub_regi}")
col_3.markdown(f"Total Produksi : {prdksi_trkcl}")
...
col_4.markdown(f"Nama Negara    : {nmlngkp_ngr}")
col_4.markdown(f"Kode Negara    : {cod}")
col_4.markdown(f"Region         : {reg_}")
col_4.markdown(f"Sub Region     : {sub_re}")
col_4.markdown(f"Total Produksi : {prediksi}")
...
col_3.markdown(f"**Negara dengan jumlah produksi 0 pada tahun {str(Tahun)} : **")
for i in range (len(lst_nm_ngr)) :
    col_3.markdown(f"Nama Negara    : {lst_nm_ngr[i]}")
    col_3.markdown(f"Kode Negara    : {lst_code_ngr[i]}")
    col_3.markdown(f"Region         : {lst_region[i]}")
    col_3.markdown(f"Sub Region     : {lst_sub_region[i]}")
...
col_4.markdown(f"**Negara dengan jumlah produksi kumulatif = 0 :**")
for i in range (len(list_nm_ngr)) :
    col_4.markdown(f"Nama Negara    : {list_nm_ngr[i]}")
    col_4.markdown(f"Kode Negara    : {list_code_ngr[i]}")
    col_4.markdown(f"Region         : {list_region[i]}")
    col_4.markdown(f"Sub Region     : {list_sub_region[i]}")
#>>>>>>>>>>>> Mid Column 4 <<<<<<<<<<<<#
