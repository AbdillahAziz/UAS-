# Streamlit Demo: Statistic Production of Oil from different countries
This repo contains a simple [streamlit](https://streamlit.io) app that shows interactive plots of some statistics about production of oil from different countries. 
